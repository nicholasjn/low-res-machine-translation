...
#SBATCH --job-name=qwen15_hsb_de_100k
#SBATCH --output=/dss/dsshome1/04/go82lec2/NLP-26SS/logs/qwen15_hsb_de_100k_%j.out
#SBATCH --error=/dss/dsshome1/04/go82lec2/NLP-26SS/logs/qwen15_hsb_de_100k_%j.err
...
python3 train_qwen_lora.py \
  ...
  --output_dir ../models/qwen15-lora-hsb-de-kde4-wmt22-lid-100k-1epoch \
  --num_train_epochs 1 \
  --learning_rate 2e-4 \
