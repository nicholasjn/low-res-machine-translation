...
#SBATCH --job-name=qwen_de_hsb_100k
#SBATCH --output=/dss/dsshome1/04/go82lec2/NLP-26SS/logs/qwen_de_hsb_100k_%j.out
#SBATCH --error=/dss/dsshome1/04/go82lec2/NLP-26SS/logs/qwen_de_hsb_100k_%j.err
...
python3 train_qwen_lora.py \
  ...
  --max_length 256 \
  --load_in_4bit True \
  --output_dir ../models/qwen-7b-lora-de-hsb-kde4-wmt22-lid-100k-1epoch
