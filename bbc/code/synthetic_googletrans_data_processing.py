...
INPUT_PATHS = [
    # "sentence_pairs_data/synthetic_nllb_10000_id70_en30_to_bbc_googletrans.jsonl",
    # "sentence_pairs_data/synthetic_nllb_85000_id70_en30_to_bbc_googletrans.jsonl",
    # "sentence_pairs_data/synthetic_nllb_49804_id_en_to_bbc_googletrans.jsonl",
    # "sentence_pairs_data/synthetic_nllb_10000_id_en_to_bbc_googletrans.jsonl",
    "sentence_pairs_data/synthetic_nllb_10000_en_to_bbc_googletrans.jsonl"
]

OUTPUT_PATH = Path(
    # "sentence_pairs_data/synthetic_nllb_id_en_to_bbc_googletrans_clean.jsonl"
    "sentence_pairs_data/synthetic_nllb_en_to_bbc_googletrans_clean.jsonl"
)

REJECTED_PATH = Path(
    # "sentence_pairs_data/synthetic_nllb_id_en_to_bbc_googletrans_rejected.jsonl"
    "sentence_pairs_data/synthetic_nllb_en_to_bbc_googletrans_rejected.jsonl"
)
...
def clean_parallel_corpus(df):
    ...
    # Normalize metadata
    for col in ["src_lang", "tgt_lang", "source_dataset", "generation_method", "split"]:
    ...
    for col in ["source", "target", "original_en", "original_id"]:
